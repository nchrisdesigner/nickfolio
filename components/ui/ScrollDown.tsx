export default function ScrollDown() {
  return (
    <div className="w-[6rem] h-[6rem] rounded-full border border-primary-foreground grid place-items-center">
      <div className="grid place-items-center w-[2rem] h-[2.8rem]">
        <svg
          width="100%"
          height="100%"
          viewBox="0 0 26 27"
